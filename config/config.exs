...
#   render_errors: [
#     formats: [html: LauraWeb.ErrorHTML, json: LauraWeb.ErrorJSON],
#     layout: false
#   ],
#   pubsub_server: Laura.PubSub,
#   live_view: [signing_salt: "yKoRHyEO"]
...
config :laura, LauraWeb.Endpoint,
  ...
  pubsub_server: Laura.PubSub,
  live_view: [signing_salt: "wawRQ79f"]
